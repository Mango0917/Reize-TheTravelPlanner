...
/////
$id=$_GET['id'];
$inDate=$_GET['bookingDate'];
$outDate=$_GET['returnDate'];
$c_name=$_GET['city'];
$State=$_GET['state'];
$NEW=$_GET['id'];
//$numGuests=$_GET['num'];

$stmt="SELECT * FROM CAR,CAR_CATEGORY where CAR.CAR_CATEGORY_NAME=CAR_CATEGORY.CATEGORY_NAME and CAR.REGISTRATION_NUMBER=LTRIM(RTRIM('$id'))";
...
if (isset($_POST['postsubmit'])){
    ...
    $stmt="INSERT INTO CBOOKING VALUES('','$email',LTRIM(RTRIM('$id')),TO_DATE('$inDate'),TO_DATE('$outDate'),'$phpPrice')";
    $stid=oci_parse($conn,$stmt);
    if( !oci_execute($stid) ) {
        //echo "ERRRROOORRR";
        $e = oci_error();
	...
	$stmt="UPDATE CAR SET AVAILABLE= AVAILABLE-1 WHERE REGISTRATION_NUMBER=LTRIM(RTRIM('$id'))";
    $stid=oci_parse($conn,$stmt);
    if( !oci_execute($stid) ) {
        //echo "ERRRROOORRR";
        $e = oci_error();
...
<label class="form-inline" style="color:#F26351; font-weight:bold;  font-size:1.3em;"><h3 style="color:#FFFFFF" >Registration ID:</h3></label>
<label style="color:#F26351;  "><h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" > <?php echo $id ?></h3> </label>
<BR/>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold;  font-size:1.3em;"><h3 style="color:#FFFFFF" >CATEGORY:</h3></label>
<label style="color:#F26351; "><h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" > <?php echo $category ?> </h3></label>
<BR/>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold;  font-size:1.3em;"><h3 style="color:#FFFFFF" >MAKE:</h3></label>
<label style="color:#F26351;  "> <h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" ><?php echo $make ?></h3> </label>
<BR/>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold;  font-size:1.3em;"><h3 style="color:#FFFFFF" >MODEL NAME:</h3></label>
<label style="color:#F26351; "> <h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" ><?php echo $model ?> </h3></label>
<BR/>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold;  font-size:1.3em;"><h3 style="color:#FFFFFF" >MODEL YEAR:</h3></label>
<label style="color:#F26351;  "> <h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" ><?php echo $year ?></h3> </label>
<BR/>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold; font-size:1.3em;"><h3 style="color:#FFFFFF" >MILEAGE:</h3></label>
<label style="color:#F26351; "> <h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" ><?php echo $mileage ?> </h3></label>
<BR/>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold; font-size:1.3em;"><h3 style="color:#FFFFFF" >Booking Date:</h3></label>
<label style="color:#F26351; "><h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" > <?php echo $inDate ?> </h3></label>
<BR/>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold; font-size:1.3em;"><h3 style="color:#FFFFFF" >Return Date:</h3></label>
...
<label style="color:#F26351; "><h3 style="color:#c5b291; font-weight:bold; font-size:1.3em;" > <?php echo $noOfDays." * $".$price." = $".$phpPrice ?> </h3></label>
<br/>
<BR/>
