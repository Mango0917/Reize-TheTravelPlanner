...
if( !oci_execute($stid) ) {
	...
	print "<th>Price(USD)</th>\n";
	//print "<th>Seats</th>\n";
	print "<th>Date of Departure</th>\n";
	print "<th>Time of Departure</th>\n";
    print "<th>Date of Arrival</th>\n";
	print "<th>Time of Arrival</th>\n";
	print "<th>Flight Duration</th>\n";
	print "<th>Source Airport</th>\n";
	print "<th>Destination Airport</th>\n";
	print "<th>Book</th>\n";
	...
	while ($row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) {
		...
		echo "<td><a href='try.php?id={$ID}&date={$DDATE}&time={$DEPTIME}&name={$FNAME}&num={$NO_OF_PASSENGERS}'>BOOK NOW</a></td>";
    	echo "</tr>\n";
	}
	//$V=$row['FL_ID'];
			  ...
			  <div class="container-fluid" style="margin: 10px;">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-top: 10px;">
			      ...
			      <ul class="nav navbar-nav navbar-right nav-heads">
			        ...
			        <li><a href="flight.php" style="color:#F26351; font-weight:bold">FLIGHTS</a></li>
...
<br/>
 <h1 align="center" style="color:#F26351; font-weight:bold;"> FLIGHTS </h1>
        <hr/>
<div class="col-md-4 col-md-offset-4">
<div class="form-group" >
<form action="" method="post">
<label class="form-inline" style="color:#F26351; font-weight:bold;"><h3 style="color:#F26351" >FROM:</h3></label>
...
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold"><h3 style="color:#F26351" >DATE OF DEPARTURE:</h3></label>
<input id="DEP_DATE" style:"color:#000000" class="form-control" type="text" name="DEP_DATE" required>
<BR/>
<label class="form-inline" style="color:#F26351; font-weight:bold"><h3 style="color:#F26351" >NUMBER OF PASSENGERS:</h3></label>
